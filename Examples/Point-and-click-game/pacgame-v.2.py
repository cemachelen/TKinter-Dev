...
class GameScreen():
    def __init__(self, master, image, roi, inventory_item=None,
                 help_text=None, required_item=None):
        self.master = master
        self.roi = roi
...
class Game(tk.Tk):
    def __init__(self):
        ...
        self.success_font = font.Font(
            family="ubuntu", size=50, weight=font.BOLD)
        self.cannot_use_font = font.Font(
            family="ubuntu", size=28, weight=font.BOLD)
        self.item_in_use = ""
        self.has_won = False
        ...
        self.question_mark_image = tk.PhotoImage(
            file="assets/questionmark.png")
        ...
        self.help_box = tk.Label(self.right_frame, textvar=self.help_var,
                                 bg="black", fg="white", padx=10, pady=20)
        ...
        help_history_box_1 = tk.Label(self.right_frame,
                                      textvar=self.help_history_var_1,
                                      bg="black", fg="white", padx=10, pady=10)
        help_history_box_2 = tk.Label(self.right_frame,
                                      textvar=self.help_history_var_2,
                                      bg="black", fg="white", padx=10, pady=10)
        help_history_box_3 = tk.Label(self.right_frame,
                                      textvar=self.help_history_var_3,
                                      bg="black", fg="white", padx=10, pady=10)
        ...
        inventory_title = tk.Label(self.right_frame, text="Inventory:",
        ...
        item_label_1 = tk.Label(
            inventory_row_1, textvar=item_name_1, anchor="w")
        item_label_2 = tk.Label(
            inventory_row_2, textvar=item_name_2, anchor="w")
        item_label_3 = tk.Label(
            inventory_row_3, textvar=item_name_3, anchor="w")
    ...
    def show_next_screen(self):
        ...
        if self.current_screen_number < len(self.game_screens):
            ...
            self.screen.create_text((250, 300), text="You Win!",
                                    font=self.success_font, fill="white")
            self.has_won = True
    ...
    def use_item(self, item_number):
        if item_number < len(self.inventory_slots_in_use):
            ...
            if item_name:
                ...
                self.inventory_slots[item_number].configure(
                    command=self.clear_used_item)
    ...
    def show_cannot_use_message(self):
        text_id = self.screen.create_text((250, 25),
                                          text="You cannot use that there!",
...
if __name__ == "__main__":
    ...
    scene1 = GameScreen(game, "assets/scene1.png", (378, 135, 427, 217),
                        "key", "You Need To Leave but the Door is Locked!")
    scene2 = GameScreen(game, "assets/scene2.png",
                        (117, 54, 329, 412), None, "You Got the Key!", "key")
    scene3 = GameScreen(game, "assets/scene3.png",
                        (117, 54, 329, 412), None, "The Door is Open!")
